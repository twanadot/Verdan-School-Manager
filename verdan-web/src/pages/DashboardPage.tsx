      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {isSuperAdmin && (
          <DashCard
            ...
            icon={<Building2 />}
            title="Institusjoner"
            description="Administrer skoler og campuser"
            color="text-rose-400"
          />
        )}
        {isSuperAdmin && (
          <>
            <DashCard
              ...
              icon={<Users />}
              title="Brukere"
              description="Administrer administratorer for hver institusjon"
        ...
        {isInstAdmin && (
          <>
            <DashCard
              ...
              icon={<Users />}
              title="Brukere"
              description="Administrer elever, lærere og administratorer"
              color="text-purple-400"
            />
            <DashCard
              to="/subjects"
              icon={<BookOpen />}
              title="Fag"
              description="Administrer kurs og fag"
              color="text-blue-400"
            />
            <DashCard
              to="/grades"
              icon={<GraduationCap />}
              title="Karakterer"
              description="Se og administrer alle karakterer"
            ...
            <DashCard
              ...
              icon={<ClipboardList />}
              title="Fravær"
              description="Følg opp elevfravær"
            ...
            <DashCard
              ...
              icon={<DoorOpen />}
              title="Rom"
              description="Administrer rom og kapasitet"
              color="text-cyan-400"
            />
            <DashCard
              to="/bookings"
              icon={<Calendar />}
              title="Timeplan"
              description="Planlegg rombookinger"
              color="text-pink-400"
            />
            <DashCard
              to="/chat"
            ...
            <DashCard
              ...
              icon={<GraduationCap />}
              title="Uteksaminerte"
              description="Se uteksaminerte elever"
            ...
            <DashCard
              ...
              icon={<FileSearch />}
              title="Søknadsportal"
              description="Administrer opptak og søknader"
            ...
            <DashCard
              ...
              icon={<BookOpenCheck />}
              title="Elevportalen"
              description="Mapper, innleveringer og kunngjøringer"
        ...
        {user.role === 'TEACHER' && (
          <>
            ...
            <DashCard
              ...
              icon={<GraduationCap />}
              title="Karakterer"
              description="Administrer elevkarakterer"
              color="text-green-400"
            />
            <DashCard
              to="/attendance"
            ...
            <DashCard
              ...
              icon={<Calendar />}
              title="Timeplan"
              description="Book rom for undervisning"
              color="text-pink-400"
            />
            <DashCard
              to="/chat"
        ...
        {user.role === 'STUDENT' && (
          <>
            <DashCard
              ...
              icon={<BookOpen />}
              title="Fag"
              description="Se fagene du er meldt opp i"
              color="text-blue-400"
            />
            <DashCard
              to="/grades"
              icon={<GraduationCap />}
              title="Mine karakterer"
              description="Sjekk dine resultater"
              color="text-green-400"
            />
            <DashCard
              to="/attendance"
              icon={<ClipboardList />}
              title="Mitt fravær"
              description="Se din fraværsoversikt"
              color="text-amber-400"
            />
            <DashCard
              to="/chat"
            ...
            <DashCard
              ...
              icon={<FileSearch />}
              title="Søknadsportal"
              description="Søk på studier og programmer"
              color="text-orange-400"
            />
            <DashCard
              to="/student-portal"
